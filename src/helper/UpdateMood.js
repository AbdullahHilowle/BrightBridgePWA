...
window.addEventListener('load', () => {
      ...
      if (window.netlifyIdentity) {
        ...
        const syncFromUser = (user) => {
          const resolvedName = (typeof identityDisplay.syncStoredDisplayName === 'function')
          ...
          userDisplay.textContent = resolvedName;
        };
